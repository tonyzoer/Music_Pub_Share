...
public class MusicActivity extends AppCompatActivity implements CurrentSessionCallback, View.OnClickListener, Slider.OnValueChangedListener {
    ...
    BroadcastReceiver nextSongBroadcastReceiver = new BroadcastReceiver() {
        @Override
    ...
    BroadcastReceiver previousSongBroadcastReceiver = new BroadcastReceiver() {
        @Override
        public void onReceive(Context context, Intent intent) {
            streamingManager.onSkipToPrevious();
        }
    ...
    BroadcastReceiver pauseSongBroadcastReceiver = new BroadcastReceiver() {
        @Override
        public void onReceive(Context context, Intent intent) {
            streamingManager.onPause();
        }
